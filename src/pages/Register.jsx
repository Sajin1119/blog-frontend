    ...
    <>
      <style>{`
        ...
        * { font-family: 'DM Sans', sans-serif; }
        ...
        .field-animate { animation: fadeSlideIn 0.4s ease both; }
        .field-animate:nth-child(1) { animation-delay: 0.1s; }
        .field-animate:nth-child(2) { animation-delay: 0.18s; }
        .field-animate:nth-child(3) { animation-delay: 0.26s; }
        .field-animate:nth-child(4) { animation-delay: 0.34s; }
        .field-animate:nth-child(5) { animation-delay: 0.42s; }
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'rgba(224,201,127,0.04)'
        }} />

        <div style={{ width: '100%', maxWidth: '430px', position: 'relative', zIndex: 1 }}>

          {/* Brand */}
          <div className="text-center mb-4" style={{ animation: 'fadeSlideUp 0.4s ease both' }}>
            ...
            <div className="success-pop" style={{
              ...
              <div style={{
                ...
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                  <polyline className="check-draw" points="7,18 15,26 29,10"
            ...
            <div className="card-animate" style={{
              ...
              {error && (
                <div style={{
                  ...
                  color: '#c0392b', fontSize: '0.875rem', marginBottom: '20px',
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="field-animate" style={{ marginBottom: '16px' }}>
                  <label style={{
                  ...
                  <input
                    type="text" name="username" className="form-control reg-input"
                ...
                <div className="field-animate" style={{ marginBottom: '16px' }}>
                  ...
                  <input
                    type="email" name="email" className="form-control reg-input"
                    placeholder="your@email.com"
                    value={formData.email} onChange={handleChange} required
                  />
                </div>

                <div className="field-animate" style={{ marginBottom: '8px' }}>
                  <label style={{
                    display: 'block', fontSize: '0.72rem', fontWeight: 600,
                    textTransform: 'uppercase', letterSpacing: '1px',
                    color: '#999', marginBottom: '6px'
                  ...
                  <div style={{ position: 'relative' }}>
                    <input
                      ...
                      name="password" className="form-control reg-input"
                  ...
                  {strength && (
                    <div style={{ marginTop: '8px' }}>
                      ...
                      <p style={{ fontSize: '0.75rem', color: strength.color, marginTop: '4px', marginBottom: 0 }}>
                ...
                <div className="field-animate" style={{ marginBottom: '24px' }}>
                  <label style={{
                    display: 'block', fontSize: '0.72rem', fontWeight: 600,
                    textTransform: 'uppercase', letterSpacing: '1px',
                    color: '#999', marginBottom: '6px'
                  ...
                  <div style={{ position: 'relative' }}>
                    <input
                      ...
                      name="password2" className="form-control reg-input"
                  ...
                  {formData.password2 && (
                    <p style={{
                      fontSize: '0.75rem', marginTop: '4px', marginBottom: 0,
                      color: formData.password === formData.password2 ? '#27ae60' : '#e74c3c'
                    }}>
              ...
              <p style={{ textAlign: 'center', fontSize: '0.875rem', color: '#666', marginBottom: 0 }}>
                ...
                <Link to="/login" style={{ color: '#1a1a2e', fontWeight: 700, textDecoration: 'none' }}>
                  Sign in →
                </Link>
              </p>
